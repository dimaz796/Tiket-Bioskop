...
WHERE film.status_film = 'Akan Datang'
ORDER BY film.tayang ASC
";
...
<head>
    ...
    <title> Film Akan Datang</title>
</head>

<body class="body">
    <div class="container mt-3">
        <div class="fs-3 fw-semibold">Film Akan Datang</div>
        <!-- Daftar Film -->
        <div class="row pb-5">

            <?php if ($count < 1) {
                echo "<div class='fs-5 fw-semibold text-secondary mt-3'>* Belum Ada Film Yang Akan Datang</div>
                ";
            } else {
                foreach ($querry as $row) : ?>
                    <div class="col-md-3 col-sm-4 col-6">
                        <div class="card card-transparent shadow-lg bg-body-dark rounded mt-4 border border-dark" style="height: 37rem;overflow: hidden;">
